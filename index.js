...
async function init() {
  ...
  for (const languageIndex in languages) {
    ...
    fs.writeFileSync(outputFile, JSON.stringify(JSON.parse(completion.data.choices[0].message.content), null, 2))
  }
}
